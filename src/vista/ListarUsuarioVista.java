...
public class ListarUsuarioVista extends JFrame {
    ...
    private JLabel lblNombre, lblFechaCreacion, lblUltimoAcceso;
    ...
    public ListarUsuarioVista() {
        ...
        gbc.gridx = 0; gbc.gridy = 1; panelDerecho.add(new JLabel("<html><b>Fecha Creación:</b></html>"), gbc);
        gbc.gridx = 1; gbc.gridy = 1; lblFechaCreacion = new JLabel("-"); lblFechaCreacion.setFont(ConstantesUI.FUENTE_NORMAL); panelDerecho.add(lblFechaCreacion, gbc);

        gbc.gridx = 0; gbc.gridy = 2; panelDerecho.add(new JLabel("<html><b>Último Acceso:</b></html>"), gbc);
        gbc.gridx = 1; gbc.gridy = 2; lblUltimoAcceso = new JLabel("-"); lblUltimoAcceso.setFont(ConstantesUI.FUENTE_NORMAL); panelDerecho.add(lblUltimoAcceso, gbc);

        gbc.gridx = 0; gbc.gridy = 3; gbc.gridwidth = 2; gbc.fill = GridBagConstraints.NONE; gbc.anchor = GridBagConstraints.SOUTHEAST; gbc.weighty = 1.0;
